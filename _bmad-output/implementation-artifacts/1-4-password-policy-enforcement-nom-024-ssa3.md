...
- `src/modules/auth/server/password-policy.ts` (MODIFIED — Task 1)
- `src/modules/auth/server/password-policy.test.ts` (NEW — Task 1)
...
- `src/modules/auth/server/sign-in.action.ts` (MODIFIED — Task 5)
- `tests/integration/auth-sign-in-lockout.test.ts` (NEW — Task 6)
